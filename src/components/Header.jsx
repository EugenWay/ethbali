        ...
        <div className={`absolute top-20 left-0 right-0 bg-yellow-300 border-b-2 border-slate-900 transition-transform duration-300 ${open ? 'translate-y-0' : '-translate-y-4'}`}>
          <div className="flex flex-col px-6 py-6 gap-1">
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={close}
              className="mt-4 inline-flex items-center justify-center gap-2 px-6 py-3 bg-slate-900 border-2 border-slate-900 rounded-full font-syne font-semibold text-base uppercase tracking-tight text-yellow-300 hover:bg-blue-600 transition-colors"
            >
              Book a Call →
            </a>
          </div>
